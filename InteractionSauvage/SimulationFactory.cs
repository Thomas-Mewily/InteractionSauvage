...
public class SimulationFactory : SimulationComposante
{
    ...
    public MachineEtat MoutonME() 
    {
        ...
        MoutonME.Add("marcher",  new Marcher(0.5), new Transition("cours ma gazelle", new Apres(2), "courrir"));
        MoutonME.Add("courrir",  new Marcher(1),   new Transition("je suis epuise",   new Apres(2), "attendre"));
